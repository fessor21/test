...
public abstract class PageBaseAbstract{
	  ...
	  /**
		 ...
		 * @param id  元素的id属性
		 */
		abstract void findId(WebDriver driver, String id); 
		/**
		 * 根据name查找
		 * @param driver 驱动
		 * @param name 元素的name属性 
		 */
		abstract  void findName(WebDriver driver, String name); 
	    /**
	     * 根据xpath查找
	     * @param driver 驱动
	     * @param xpath  xpath路径
	     */
		abstract  void findXpath(WebDriver driver,String xpath);
		/**
		 * 根据className查找
		 * @param driver     驱动
